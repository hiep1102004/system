...
(4, 'Bánh mì', 'sda', '213213214', 'qwwwwwi@gmail.com', '2024-03-12', 2, 1);
...
(4, 92, '../Uploads/vay2.jpg', 'Skirt Luxury 2', 6000, 6000, 1, 4);
...
--
ALTER TABLE `tb_bill`
  MODIFY `id_bill` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
